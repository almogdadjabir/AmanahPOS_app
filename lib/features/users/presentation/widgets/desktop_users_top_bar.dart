...
class DesktopUsersTopBar extends StatelessWidget {
  final TextEditingController searchCtrl;
  final Future<void> Function() onRefresh;

  const DesktopUsersTopBar({
    super.key,
    ...
    return AnimatedBuilder(
      ...
      builder: (ctx, _) {
        ...
        return TextField(
          ...
          style: AppTextStyles.bs200(ctx).copyWith(
            color: colors.textPrimary,
            fontWeight: FontWeight.w700,
          ),
          decoration: InputDecoration(
            ...
            hintStyle: AppTextStyles.bs200(ctx).copyWith(
