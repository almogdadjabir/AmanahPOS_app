...
import 'package:amana_pos/features/customers/presentation/widgets/customer_sheet_widgets.dart';
...
class _CustomerFormSheetState extends State<_CustomerFormSheet> {
  ...
  void dispose() {
    ...
    _addressCtrl.dispose(); _notesCtrl.dispose();   _pointsCtrl.dispose();
    _nameFocus.dispose();   _phoneFocus.dispose();  _emailFocus.dispose();
    _addressFocus.dispose(); _notesFocus.dispose(); _pointsFocus.dispose();
    super.dispose();
  }
  ...
  void _submit() {
    ...
    if (_isEdit) {
      ...
      if (id == null) return;
      context.read<CustomersBloc>().add(OnUpdateCustomer(customerId: id, dto: dto));
    } else {
      context.read<CustomersBloc>().add(OnCreateCustomer(dto: dto));
    }
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AppFormField(
                          ...
                          nextFocus:  _phoneFocus, hint: 'Sara Ali',
                          prefixIcon: Icons.person_outline_rounded,
                          validator:  CustomerFormValidators.name,
                        ),
                        const SizedBox(height: AppDims.s3),
                        ...
                        AppFormField(
                          ...
                          nextFocus:   _emailFocus,  hint: '+249922222222',
                          prefixIcon:  Icons.phone_outlined,
                          keyboardType: TextInputType.phone,
                          validator:   CustomerFormValidators.phone,
                        ),
                        const SizedBox(height: AppDims.s3),
                        ...
                        AppFormField(
                          ...
                          nextFocus:   _addressFocus, hint: 'sara@example.com',
                          prefixIcon:  Icons.email_outlined,
                          keyboardType: TextInputType.emailAddress,
                          validator:   CustomerFormValidators.email,
                        ),
                        const SizedBox(height: AppDims.s3),
                        ...
                        AppFormField(
                          ...
                          validator:       CustomerFormValidators.loyaltyPoints,
                        ),
