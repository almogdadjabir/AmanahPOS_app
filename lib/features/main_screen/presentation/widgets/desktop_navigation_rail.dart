...
class _DesktopNavigationRailState extends State<DesktopNavigationRail> {
        ...
        return NavigationRail(
          ...
          trailing: Expanded(
            child: Column(
              ...
              children: [
                // More button (visible when there are overflow features OR always
                // so the user can access Settings via the drawer).
                _MoreButton(
                  extended: _extended,
  ...
  int? _activeRailIndex(List<NavTab> railTabs, AppFeature? currentFeature) {
