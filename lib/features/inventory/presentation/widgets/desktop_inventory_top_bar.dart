...
/// Desktop inventory header: brand mark + title, a wide live-search field
/// and a refresh action — replaces the mobile sliver app bar so the page
/// reads as a control surface, not a list.
class DesktopInventoryTopBar extends StatelessWidget {
  final TextEditingController searchCtrl;
  final Future<void> Function() onRefresh;

  const DesktopInventoryTopBar({
    super.key,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Stock levels, alerts & shop movements',
      ...
      builder: (context, _) {
        ...
        return TextField(
          ...
          decoration: InputDecoration(
            isDense: true,
            hintText: 'Search by product, SKU or shop',
