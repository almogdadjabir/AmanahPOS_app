...
/// Desktop catalog header: brand mark + title, a wide live-search field,
/// a grid/list toggle, refresh and the primary "Add product" action —
/// mirrors [DesktopInventoryTopBar] so Products reads as the same control
/// surface as Inventory.
class DesktopProductsTopBar extends StatelessWidget {
  final TextEditingController searchCtrl;
  final bool isRestaurant;
  final Future<void> Function() onRefresh;

  const DesktopProductsTopBar({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ProductBloc, ProductState>(
      ...
      builder: (context, state) {
        return Tooltip(
          message: state.isGrid ? tr.showList : tr.showGrid,
          child: Material(
